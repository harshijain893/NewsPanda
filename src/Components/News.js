...
class News extends Component {
    static defaultProps = {
        country: 'in',
        pageSize: 3, // Change this to match your desired page size
    ...
    render() {
        ...
        // Calculate the start and end indices of the articles to display
        ...
        return (
            <div className="container my-3">
                ...
                <div className="row">
                    {!this.state.loading && currentArticles.map((element, index) => {
...
// //         //    let url=`https://serpapi.com/search.json?engine=google_news&topic_token=CAAqJggKIiBDQkFTRWdvSUwyMHZNRGRqTVhZU0FtVnVHZ0pWVXlnQVAB`;
// //             let url = `https://newsapi.org/v2/top-headlines?country=${country}&category=${category}&pageSize=${pageSize}&page=${page}&apiKey=c9f9ac00e5434124bddf55b26f1be330`;
